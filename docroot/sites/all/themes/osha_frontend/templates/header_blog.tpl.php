...
<div id="socialNetworksBlue">
  <div id="icons">
    ...
    <a target="_blank" href="<?php echo url('tools-and-resources/blog', array('alias' => TRUE)); ?>"><img src="/sites/all/themes/osha_frontend/images/bloggerTop.png" alt="Blogger"></a>
  </div>
</div>
