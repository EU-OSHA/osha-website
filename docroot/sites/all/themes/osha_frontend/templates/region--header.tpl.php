<div id="socialNetworksBlue">
	<div id="icons">
        ...
        <a target="_blank" href="<?php echo url('tools-and-resources/blog', array('alias' => TRUE)); ?>"><img src="/sites/all/themes/osha_frontend/images/blogger-icon.png" alt="EU OSHA Blog with more information in workplace safety and health" title="Blog"></a>
	</div>
</div>
...
<div id="multi-lingual-award"><a href="<?php print ($url);?>"><img src="/sites/all/themes/osha_frontend/images/stamp.png" alt="25 anniversary"></a></div>
