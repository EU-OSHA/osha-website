  ...
  <div id="sub-browse-wrapper">
    ...
    <div id="file-header-wrapper">
      <table id="file-header" class="files"><tbody><tr>
        ...
        <td <?php echo $style; ?> class="width"><?php print t('Width'); ?></td>
        <td <?php echo $style; ?> class="height"><?php print t('Height'); ?></td>
...
<div <?php echo $style; ?> id="browse-resizer" class="y-resizer"></div>

<div <?php echo $style; ?> id="preview-wrapper"><div id="file-preview"></div></div>
